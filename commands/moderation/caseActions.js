...
const data = new SlashCommandBuilder()
    .setName('case')
    .setNameLocalizations(localeManager.getLocalizations('moderation.case.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('remove')
        .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.remove.name'))
        .setDescription(localeManager.get('moderation.case.description', 'en-US'))
        .setDescriptionLocalizations(localeManager.getLocalizations('moderation.case.options.remove.description'))
        .addIntegerOption(opt => 
            opt.setName('num')
            .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.remove.options.num.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('reason')
        .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.reason.name'))
        .setDescription(localeManager.get('moderation.case.description', 'en-US'))
        .setDescriptionLocalizations(localeManager.getLocalizations('moderation.case.options.reason.description'))
        .addIntegerOption(opt => 
            opt.setName('num')
            .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.reason.options.num.name'))
        ...
        .addStringOption(opt =>
            opt.setName('reason')
            .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.reason.options.reason.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('view')
        .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.view.name'))
        .setDescription(localeManager.get('moderation.case.description', 'en-US'))
        .setDescriptionLocalizations(localeManager.getLocalizations('moderation.case.options.view.description'))
        .addIntegerOption(opt => 
            opt.setName('num')
            .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.view.options.num.name'))
    ...
    .addSubcommand(sub =>
        ...
        .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.user_punishments.name'))
        .setDescription(localeManager.get('moderation.case.description', 'en-US'))
        .setDescriptionLocalizations(localeManager.getLocalizations('moderation.case.options.user_punishments.description'))
        .addUserOption(option =>
            option.setName('user')
                .setNameLocalizations(localeManager.getLocalizations('moderation.case.options.user_punishments.options.user.name'))
