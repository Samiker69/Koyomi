...
const data = new SlashCommandBuilder()
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.ban.name'))
        .setDescription(localeManager.getString('commands.moderation.ban.description'))
        .addUserOption(option =>
            option.setName(localeManager.getString('commands.moderation.ban.options.user.name'))
                .setDescription(localeManager.getString('commands.moderation.ban.options.user.description'))
                .setRequired(true)
        )
        .addStringOption(option =>
            option.setName(localeManager.getString('commands.moderation.ban.options.reason.name'))
                .setDescription(localeManager.getString('commands.moderation.ban.options.reason.description'))
                .setRequired(false)
        )
        .addAttachmentOption(option =>
            option.setName(localeManager.getString('commands.moderation.ban.options.evidence.name'))
                .setDescription(localeManager.getString('commands.moderation.ban.options.evidence.description'))
                .setRequired(false)
        )
    )
    .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.mute.name'))
        .setDescription(localeManager.getString('commands.moderation.mute.description'))
        .addUserOption(option =>
          option.setName(localeManager.getString('commands.moderation.mute.options.user.name'))
                .setDescription(localeManager.getString('commands.moderation.mute.options.user.description'))
                .setRequired(true)
        )
        .addStringOption(option =>
          option.setName(localeManager.getString('commands.moderation.mute.options.time.name'))
                .setDescription(localeManager.getString('commands.moderation.mute.options.time.description'))
                .setRequired(false)
        )
        .addStringOption(option =>
          option.setName(localeManager.getString('commands.moderation.mute.options.reason.name'))
                .setDescription(localeManager.getString('commands.moderation.mute.options.reason.description'))
                .setRequired(false)
        )
        .addAttachmentOption(option =>
          option.setName(localeManager.getString('commands.moderation.mute.options.evidence.name'))
                .setDescription(localeManager.getString('commands.moderation.mute.options.evidence.description'))
                .setRequired(false)
        )
    )
    .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.kick.name'))
        .setDescription(localeManager.getString('commands.moderation.kick.description'))
        .addUserOption(option =>
            option.setName(localeManager.getString('commands.moderation.kick.options.user.name'))
                .setDescription(localeManager.getString('commands.moderation.kick.options.user.description'))
                .setRequired(true)
        )
        .addStringOption(option =>
            option.setName(localeManager.getString('commands.moderation.kick.options.reason.name'))
                .setDescription(localeManager.getString('commands.moderation.kick.options.reason.description'))
                .setRequired(false)
        )
        .addAttachmentOption(option =>
            option.setName(localeManager.getString('commands.moderation.kick.options.evidence.name'))
                .setDescription(localeManager.getString('commands.moderation.kick.options.evidence.description'))
                .setRequired(false)
        )
    )
    .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.unmute.name'))
        .setDescription(localeManager.getString('commands.moderation.unmute.description'))
        .addUserOption(option =>
          option.setName(localeManager.getString('commands.moderation.unmute.options.user.name'))
            .setDescription(localeManager.getString('commands.moderation.unmute.options.user.description'))
            .setRequired(true)
        )
        .addStringOption(option =>
          option.setName(localeManager.getString('commands.moderation.unmute.options.reason.name'))
            .setDescription(localeManager.getString('commands.moderation.unmute.options.reason.description'))
            .setRequired(false)
        )
        .addAttachmentOption(option =>
          option.setName(localeManager.getString('commands.moderation.unmute.options.evidence.name'))
            .setDescription(localeManager.getString('commands.moderation.unmute.options.evidence.description'))
            .setRequired(false)
        )
    )
    .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.unban.name'))
        .setDescription(localeManager.getString('commands.moderation.unban.description'))
        .addUserOption(option =>
          option.setName(localeManager.getString('commands.moderation.unban.options.userid.name'))
            .setDescription(localeManager.getString('commands.moderation.unban.options.userid.description'))
            .setRequired(true)
        )
        .addStringOption(option =>
          option.setName(localeManager.getString('commands.moderation.unban.options.reason.name'))
            .setDescription(localeManager.getString('commands.moderation.unban.options.reason.description'))
            .setRequired(false)
        )
        .addAttachmentOption(option =>
          option.setName(localeManager.getString('commands.moderation.unban.options.evidence.name'))
            .setDescription(localeManager.getString('commands.moderation.unban.options.evidence.description'))
            .setRequired(false)
        )
    )
     .addSubcommand(sub =>
         sub.setName(localeManager.getString('commands.moderation.warn.name'))
         .setDescription(localeManager.getString('commands.moderation.warn.description'))
         .addUserOption(option =>
             option.setName(localeManager.getString('commands.moderation.warn.options.user.name'))
                 .setDescription(localeManager.getString('commands.moderation.warn.options.user.description'))
                 .setRequired(true)
         )
         .addStringOption(option =>
             option.setName(localeManager.getString('commands.moderation.warn.options.reason.name'))
                 .setDescription(localeManager.getString('commands.moderation.warn.options.reason.description'))
                 .setRequired(false)
         )
         .addAttachmentOption(option =>
             option.setName(localeManager.getString('commands.moderation.warn.options.evidence.name'))
                 .setDescription(localeManager.getString('commands.moderation.warn.options.evidence.description'))
                 .setRequired(false)
         )
     )
     .addSubcommand(sub =>
        sub.setName(localeManager.getString('commands.moderation.unwarn.name'))
        .setDescription(localeManager.getString('commands.moderation.unwarn.description'))
        .addUserOption(option =>
            option.setName(localeManager.getString('commands.moderation.unwarn.options.user.name'))
                .setDescription(localeManager.getString('commands.moderation.unwarn.options.user.description'))
                .setRequired(false)
        )
        .addNumberOption(option =>
            option.setName(localeManager.getString('commands.moderation.unwarn.options.case.name'))
                .setDescription(localeManager.getString('commands.moderation.unwarn.options.case.description'))
                .setRequired(false)
        )
        .addStringOption(option =>
            option.setName(localeManager.getString('commands.moderation.unwarn.options.reason.name'))
                .setDescription(localeManager.getString('commands.moderation.unwarn.options.reason.description'))
                .setRequired(false)
        )
        .addAttachmentOption(option =>
            option.setName(localeManager.getString('commands.moderation.unwarn.options.evidence.name'))
                .setDescription(localeManager.getString('commands.moderation.unwarn.options.evidence.description'))
                .setRequired(false)
        )
    )
