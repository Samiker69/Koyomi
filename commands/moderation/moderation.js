...
const data = new SlashCommandBuilder()
    .setName('moderation')
    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('ban')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.user.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('mute')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.user.name'))
            ...
            .addStringOption(option =>
                option.setName('time')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.time.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('kick')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.user.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('unmute')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.user.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('unban')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.name'))
            ...
            .addUserOption(option =>
                option.setName('userid')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.userid.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('warn')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.user.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.evidence.name'))
    ...
    .addSubcommand(sub =>
        sub.setName('unwarn')
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.name'))
            ...
            .addUserOption(option =>
                option.setName('user')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.user.name'))
            ...
            .addNumberOption(option =>
                option.setName('case')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.case.name'))
            ...
            .addStringOption(option =>
                option.setName('reason')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.reason.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('evidence')
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.evidence.name'))
