...
const data = new SlashCommandBuilder()
    .setName(localeManager.get('moderation.moderation.name', 'en-US'))
    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.ban.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.ban.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.user.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.ban.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.ban.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.ban.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.mute.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.mute.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.user.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.mute.options.time.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.time.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.mute.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.mute.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.mute.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.kick.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.kick.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.user.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.kick.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.kick.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.kick.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.unmute.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unmute.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.user.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unmute.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unmute.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unmute.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.unban.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unban.options.userid.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.userid.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unban.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unban.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unban.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.warn.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.warn.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.user.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.warn.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.warn.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.warn.options.evidence.name', 'name'))
    ...
    .addSubcommand(sub =>
        sub.setName(localeManager.get('moderation.moderation.options.unwarn.name', 'en-US'))
            .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.name', 'name'))
            ...
            .addUserOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unwarn.options.user.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.user.name', 'name'))
            ...
            .addNumberOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unwarn.options.case.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.case.name', 'name'))
            ...
            .addStringOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unwarn.options.reason.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.reason.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('moderation.moderation.options.unwarn.options.evidence.name', 'en-US'))
                    .setNameLocalizations(localeManager.getLocalizations('moderation.moderation.options.unwarn.options.evidence.name', 'name'))
