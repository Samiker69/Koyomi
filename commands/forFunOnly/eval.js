...
const data = new SlashCommandBuilder()
    .setName(localeManager.get('forFunOnly.eval.name'))
    .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.name', 'name'))
    ...
    .setDescriptionLocalizations(localeManager.getLocalizations('forFunOnly.eval.description'))
        .addSubcommand(subcommand =>
            subcommand.setName(localeManager.get('forFunOnly.eval.options.presence.name'))
            .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.presence.name', 'name'))
            ...
            .addStringOption(option => 
                option.setName(localeManager.get('forFunOnly.eval.options.presence.options.name-activity.name'))
                .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.presence.options.name-activity.name', 'name'))
            ...
            .addStringOption(option => 
                option.setName(localeManager.get('forFunOnly.eval.options.presence.options.status.name'))
                .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.presence.options.status.name', 'name'))
            ...
            .addIntegerOption(option =>
                option.setName(localeManager.get('forFunOnly.eval.options.presence.options.activity.name'))
                .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.presence.options.activity.name', 'name'))
        ...
        .addSubcommand(subcommand =>
            subcommand.setName(localeManager.get('forFunOnly.eval.options.avatar.name'))
            .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.avatar.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('forFunOnly.eval.options.avatar.options.file.name'))
                .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.avatar.options.file.name', 'name'))
        ...
        .addSubcommand(subcommand =>
            subcommand.setName(localeManager.get('forFunOnly.eval.options.banner.name'))
            .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.banner.name', 'name'))
            ...
            .addAttachmentOption(option =>
                option.setName(localeManager.get('forFunOnly.eval.options.banner.options.file.name'))
                .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.banner.options.file.name', 'name'))
        ...
        .addSubcommand(subcommand =>
            subcommand.setName(localeManager.get('forFunOnly.eval.options.botinfo.name'))
            .setNameLocalizations(localeManager.getLocalizations('forFunOnly.eval.options.botinfo.name', 'name'))
