...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName(localeManager.getString('commands.rolemenu.create-select.name'))
                .setDescription(localeManager.getString('commands.rolemenu.create-select.description'))
                .addChannelOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-select.options.channel.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-select.options.channel.description'))
                        .setRequired(true)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-select.options.title.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-select.options.title.description'))
                        .setRequired(true)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-select.options.description.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-select.options.description.description'))
                        .setRequired(false)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-select.options.placeholder.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-select.options.placeholder.description'))
                        .setRequired(false)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName(localeManager.getString('commands.rolemenu.create-buttons.name'))
                .setDescription(localeManager.getString('commands.rolemenu.create-buttons.description'))
                .addChannelOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-buttons.options.channel.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-buttons.options.channel.description'))
                        .setRequired(true)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-buttons.options.title.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-buttons.options.title.description'))
                        .setRequired(true)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.create-buttons.options.description.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.create-buttons.options.description.description'))
                        .setRequired(false)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName(localeManager.getString('commands.rolemenu.add-role.name'))
                .setDescription(localeManager.getString('commands.rolemenu.add-role.description'))
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.add-role.options.message_id.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.add-role.options.message_id.description'))
                        .setRequired(true)
                )
                .addRoleOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.add-role.options.role.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.add-role.options.role.description'))
                        .setRequired(true)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.add-role.options.label.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.add-role.options.label.description'))
                        .setRequired(false)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.add-role.options.description.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.add-role.options.description.description'))
                        .setRequired(false)
                )
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.add-role.options.emoji.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.add-role.options.emoji.description'))
                        .setRequired(false)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName(localeManager.getString('commands.rolemenu.remove-role.name'))
                .setDescription(localeManager.getString('commands.rolemenu.remove-role.description'))
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.remove-role.options.message_id.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.remove-role.options.message_id.description'))
                        .setRequired(true)
                )
                .addRoleOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.remove-role.options.role.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.remove-role.options.role.description'))
                        .setRequired(true)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName(localeManager.getString('commands.rolemenu.delete.name'))
                .setDescription(localeManager.getString('commands.rolemenu.delete.description'))
                .addStringOption(option =>
                    option.setName(localeManager.getString('commands.rolemenu.delete.options.message_id.name'))
                        .setDescription(localeManager.getString('commands.rolemenu.delete.options.message_id.description'))
                        .setRequired(true)
                )
        ),
