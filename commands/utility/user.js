...
const data = new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand=>
            subcommand.setName(localeManager.getString('commands.user.options.voice.name'))
            .setDescription(localeManager.getString('commands.user.options.voice.description'))
            .addUserOption(option => option.setName(localeManager.getString('commands.user.options.voice.options.target.name')).setDescription(localeManager.getString('commands.user.options.voice.options.target.description')))
            .addChannelOption(option => option.setName(localeManager.getString('commands.user.options.voice.options.channel.name')).setDescription(localeManager.getString('commands.user.options.voice.options.channel.description')))
            .addBooleanOption(option => option.setName(localeManager.getString('commands.user.options.voice.options.deaf.name')).setDescription(localeManager.getString('commands.user.options.voice.options.deaf.description')))
            .addBooleanOption(option => option.setName(localeManager.getString('commands.user.options.voice.options.mute.name')).setDescription(localeManager.getString('commands.user.options.voice.options.mute.description')))
            .addBooleanOption(option => 
                option.setName(localeManager.getString('commands.user.options.voice.options.kick.name'))
                .setDescription(localeManager.getString('commands.user.options.voice.options.kick.description'))
            )
        ).setDefaultMemberPermissions(PermissionFlagsBits.ManageRoles)

        .addSubcommand(subcommand=>subcommand.setName(localeManager.getString('commands.user.options.addrole.name')).setDescription(localeManager.getString('commands.user.options.addrole.description'))
            .addUserOption(option => option.setName(localeManager.getString('commands.user.options.addrole.options.target.name')).setDescription(localeManager.getString('commands.user.options.addrole.options.target.description')).setRequired(true))
            .addRoleOption(option => option.setName(localeManager.getString('commands.user.options.addrole.options.role.name')).setDescription(localeManager.getString('commands.user.options.addrole.options.role.description')).setRequired(true))).setDefaultMemberPermissions(PermissionFlagsBits.ManageRoles)
        .addSubcommand(subcommand=>subcommand.setName(localeManager.getString('commands.user.options.removerole.name')).setDescription(localeManager.getString('commands.user.options.removerole.description'))
            .addUserOption(option => option.setName(localeManager.getString('commands.user.options.removerole.options.target.name')).setDescription(localeManager.getString('commands.user.options.removerole.options.target.description')).setRequired(true))
            .addRoleOption(option => option.setName(localeManager.getString('commands.user.options.removerole.options.role.name')).setDescription(localeManager.getString('commands.user.options.removerole.options.role.description')).setRequired(true))).setDefaultMemberPermissions(PermissionFlagsBits.ManageRoles)
