...
const data = new SlashCommandBuilder()
        .setName(localeManager.get('utility.user.name'))
        .setNameLocalizations(localeManager.getLocalizations('utility.user.name', 'name'))
        ...
        .addSubcommand(subcommand=>
            subcommand.setName(localeManager.get('utility.user.options.voice.name'))
            .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.name', 'name'))
            ...
            .addUserOption(option => 
                option.setName(localeManager.get('utility.user.options.voice.options.target.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.options.target.name', 'name'))
            ...
            .addChannelOption(option => 
                option.setName(localeManager.get('utility.user.options.voice.options.channel.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.options.channel.name', 'name'))
            ...
            .addBooleanOption(option => 
                option.setName(localeManager.get('utility.user.options.voice.options.deaf.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.options.deaf.name', 'name'))
            ...
            .addBooleanOption(option => 
                option.setName(localeManager.get('utility.user.options.voice.options.mute.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.options.mute.name', 'name'))
            ...
            .addBooleanOption(option => 
                option.setName(localeManager.get('utility.user.options.voice.options.kick.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.voice.options.kick.name', 'name'))
        ...
        .addSubcommand(subcommand=>
            subcommand.setName(localeManager.get('utility.user.options.addrole.name'))
            .setNameLocalizations(localeManager.getLocalizations('utility.user.options.addrole.name', 'name'))
            ...
            .addUserOption(option => 
                option.setName(localeManager.get('utility.user.options.addrole.options.target.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.addrole.options.target.name', 'name'))
            ...
            .addRoleOption(option => 
                option.setName(localeManager.get('utility.user.options.addrole.options.role.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.addrole.options.role.name', 'name'))
        ...
        .addSubcommand(subcommand=>
            subcommand.setName(localeManager.get('utility.user.options.removerole.name'))
            .setNameLocalizations(localeManager.getLocalizations('utility.user.options.removerole.name', 'name'))
            ...
            .addUserOption(option => 
                option.setName(localeManager.get('utility.user.options.removerole.options.target.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.removerole.options.target.name', 'name'))
            ...
            .addRoleOption(option => 
                option.setName(localeManager.get('utility.user.options.removerole.options.role.name'))
                .setNameLocalizations(localeManager.getLocalizations('utility.user.options.removerole.options.role.name', 'name'))
