...
const data = new SlashCommandBuilder()
    .setName('guild')
    .setNameLocalizations(localeManager.getLocalizations('utility.guild.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('invites')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.invites.name'))
            ...
            .addBooleanOption(option =>
                option.setName('value')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.invites.options.value.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('banner')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.banner.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('image')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.banner.options.image.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('icon')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.icon.name'))
            ...
            .addAttachmentOption(option =>
                option.setName('image')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.icon.options.image.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('contentfilterlevel')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.contentfilterlevel.name'))
            ...
            .addStringOption(option =>
                option.setName('value')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.contentfilterlevel.options.value.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('name')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.name.name'))
            ...
            .addStringOption(option =>
                option.setName('text')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.name.options.text.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('rulechannel')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.rulechannel.name'))
            ...
            .addChannelOption(option =>
                option.setName('input')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.rulechannel.options.input.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('safetyalerts')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.safetyalerts.name'))
            ...
            .addChannelOption(option =>
                option.setName('input')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.safetyalerts.options.input.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('systemchannel')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.systemchannel.name'))
            ...
            .addChannelOption(option =>
                option.setName('input')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.systemchannel.options.input.name'))
    ...
    .addSubcommand(subcommand =>
        subcommand.setName('verificationlevel')
            .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.verificationlevel.name'))
            ...
            .addNumberOption(option =>
                option.setName('input')
                    .setNameLocalizations(localeManager.getLocalizations('utility.guild.options.verificationlevel.options.input.name'))
