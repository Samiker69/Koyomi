...
const data = new SlashCommandBuilder()
    .setName('role')
    .setNameLocalizations(localeManager.getLocalizations('utility.role.name'))
    ...
    .addSubcommand(subcommand => subcommand.setName('delete')
        .setNameLocalizations(localeManager.getLocalizations('utility.role.options.delete.name'))
        ...
        .addRoleOption(option => option.setName('role')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.delete.options.role.name'))
        ...
        .addStringOption(option => option.setName('reason')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.delete.options.reason.name'))
    ...
    .addSubcommand(subcommand => subcommand.setName('edit')
        .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.name'))
        ...
        .addRoleOption(option => option.setName('role')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.role.name'))
        ...
        .addStringOption(option => option.setName('color')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.color.name'))
        ...
        .addBooleanOption(option => option.setName('hoist')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.hoist.name'))
        ...
        .addAttachmentOption(option => option.setName('icon')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.icon.name'))
        ...
        .addBooleanOption(option => option.setName('mentionable')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.mentionable.name'))
        ...
        .addStringOption(option => option.setName('name')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.name.name'))
        ...
        .addStringOption(option => option.setName('permissions')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.permissions.name'))
        ...
        .addIntegerOption(option => option.setName('position')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.position.name'))
        ...
        .addStringOption(option => option.setName('reason')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.reason.name'))
        ...
        .addStringOption(option => option.setName('unicodeemoji')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.edit.options.unicodeemoji.name'))
    ...
    .addSubcommand(subcommand => subcommand.setName('create')
        .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.name'))
        ...
        .addStringOption(option => option.setName('color')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.color.name'))
        ...
        .addBooleanOption(option => option.setName('hoist')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.hoist.name'))
        ...
        .addBooleanOption(option => option.setName('mentionable')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.mentionable.name'))
        ...
        .addStringOption(option => option.setName('name')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.name.name'))
        ...
        .addStringOption(option => option.setName('permissions')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.permissions.name'))
        ...
        .addIntegerOption(option => option.setName('position')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.position.name'))
        ...
        .addStringOption(option => option.setName('reason')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.reason.name'))
        ...
        .addStringOption(option => option.setName('unicodeemoji')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.create.options.unicodeemoji.name'))
    ...
    .addSubcommand(subcommand => subcommand.setName('info')
        .setNameLocalizations(localeManager.getLocalizations('utility.role.options.info.name'))
        ...
        .addRoleOption(option => option.setName('role')
            .setNameLocalizations(localeManager.getLocalizations('utility.role.options.info.options.role.name'))
