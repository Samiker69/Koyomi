...
> ⚠️
> Проект более не поддерживается его мейнтейнерами. Однако, принимаются PRы и возможны некоторые мелкие фиксы.

Это многофункциональный Discord-бот. Бот создан для сообщества MojoLauncher (a.k.a. PojavLauncher СНГ), управление динамическими голосовыми каналами, разметку ролей, содержит развлекательные мини-игры.
