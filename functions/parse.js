...
function extractLogInfo(logContent) {
    const results = { 'Launcher version': null, 'Architecture': null, 'Device model': null, 'API version': null, 'Selected Minecraft version': null, 'Custom Java arguments': null, 'RAM allocated': null, 'Graphics device': null, 'MOJO_RENDERER': null, 'JAVA_HOME': null, };
    const lines = logContent.split('\n');
    const patterns = { 'Launcher version': 'Info: Launcher version:', 'Architecture': 'Info: Architecture:', 'Device model': 'Info: Device model:', 'API version': 'Info: API version:', 'Selected Minecraft version': 'Info: Selected Minecraft version:', 'Custom Java arguments': 'Info: Custom Java arguments:', 'RAM allocated': 'Info: RAM allocated:', 'Graphics device': 'Info: Graphics device:', 'MOJO_RENDERER': 'Added custom env: MOJO_RENDERER=', 'JAVA_HOME': 'Added custom env: JAVA_HOME=', };
...
/*
    const logContent = FindTxtInMessage(message, 'latestlog.txt')
    const lwjglErrorString = "The game failed to start because the currently active LWJGL version is not compatible.";
    if (logContent.includes(lwjglErrorString)) isLwjglError = true;
*/
