const forFunOnly = {
  ...
  "family": {
    ...
    "messages": {
      ...
      "adopt_no_spouse":    { "ru": "Усыновление доступно только для семейных пар. Сначала вступите в брак с помощью `/family propose`.", "en-US": "Adoption is only available to married couples. First get married using `/family propose`.", "uk": "Усиновлення доступне лише для одружених пар. Спочатку одружіться за допомогою `/family propose`." },
      ...
      "lonely_tree":        { "ru": "Вы пока одиноки. Сделайте предложение с помощью `/family propose`!", "en-US": "You are currently single. Propose to someone with `/family propose`!", "uk": "Ви поки самотні. Зробіть пропозицію за допомогою `/family propose`!" },
      ...
      "leave_married": { "ru": "Вы не можете покинуть родительскую семью, пока состоите в браке. Сначала расторгните брак с помощью `/family divorce`.", "en-US": "You cannot leave your family while you are married. First divorce using `/family divorce`.", "uk": "Ви не можете покинути батьківську родину, поки перебуваєте у шлюбі. Спочатку розлучіться за допомогою `/family divorce`." },
      "adopt_is_ancestor": { "ru": "Нельзя усыновить пользователя, который является вашим предком.", "en-US": "You cannot adopt a user who is your ancestor.", "uk": "Не можна усиновити користувача, який є вашим предком." },
      "adopt_is_descendant": { "ru": "Нельзя усыновить пользователя, который уже является вашим потомком.", "en-US": "You cannot adopt a user who is already your descendant.", "uk": "Не можна усиновити користувача, який вже є вашим нащадком." }
    }
  }
};
